...
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Email(message="Addresse email invalide")
     */
    private $email;
    ...
    /**
     * @Assert\EqualTo(propertyPath="hash", message="les deux mots de passe doivent etre identiques")
     */
    private $confirmHash;
     ...
     * @return User
     */
    public function setConfirmHash($confirmHash): self
    {
     ...
     * @Assert\Length(min="100", minMessage="100 caracteres minimum")
     */
    private $description;
